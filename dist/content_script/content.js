...
function addUdpRecordEventListenerToPage() {
  ...
  allElements.forEach((element) => {
    ...
    if (element.type != 'input') {
      ...
      console.log(element.id + " eventListener added");
    } else if (element.tagName.toLocaleLowerCase() == 'input') {
...
function removeUdpRecordEventListenerFromPage() {
  ...
  allElements.forEach((element) => {
    ...
    if(eventListeners && eventListeners[formEvent]){
        element.removeEventListener(formEvent);
    }
  });
}
